...
This project is my implementation of the first assessment throughout the Udacity's React Nanodegree Program.
...
```
git clone https://github.com/PedroNVas/react_my_reads
cd react_my_reads
